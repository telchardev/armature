...
class DocsSidebar extends StatelessWidget {
  const DocsSidebar({super.key, required this.activeSlug, this.onNavigate});

  /// Currently selected slug, highlighted in the list.
  final String activeSlug;

  /// Called after the user taps an item. Useful for closing a modal sheet.
